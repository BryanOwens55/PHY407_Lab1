...
This code is split into parts a, b, d, and e. The outputs are plots of quadrature values vs x-values chosen by gaussxw, 
as well as numerical answers for quadrature values, fractional errors, and percentage error depending on the part of the 
